            ...
            <UCard :ui="{ ring: '', divide: 'divide-y divide-gray-100 dark:divide-gray-800' }">
                ...
                <div class="flex flex-col">
                    ...
                    <UForm :schema="schema" :state="state" class="space-y-4" @submit="onSubmit">
                        ...
                        <URadioGroup
                            v-model="selected"
                            :options="[{label:'Usuário administrador', help:'Tem todos os direitos: cadastrar, excluir, etc.'}, {label:'Usuário padrão', help:'Não pode excluir cadastros e nem criar ou editar usuários.'}]"
                        />
